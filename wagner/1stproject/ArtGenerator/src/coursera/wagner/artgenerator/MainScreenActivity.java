	...
	public void onCreate(Bundle savedInstanceState) {
		...
		seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener () {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				thirdSquare.setBackgroundColor(Color.rgb(255 - progress / 2, 255 - progress / 2, 255 - progress / 2));
				thirdSquare.invalidate();
				
				// Starts light green turning green
				View forthSquare = findViewById(R.id.forthSquare);
				forthSquare.setBackgroundColor(Color.rgb(255 - progress, 255, 0));
				forthSquare.invalidate();
				
				// Starts purple turns pink
				View fifthSquare = findViewById(R.id.fifthSquare);
				fifthSquare.setBackgroundColor(Color.rgb(128, 0, 255 - progress));
